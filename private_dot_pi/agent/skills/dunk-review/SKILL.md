...
If the user provided additional context alongside this skill invocation, treat it as supplementary review guidance. Apply it when interpreting and addressing each comment (e.g. "this is a performance-sensitive path", "prefer X over Y", repo-specific conventions). Don't discard it.
