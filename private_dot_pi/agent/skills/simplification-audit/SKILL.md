...
description: Read-only, agent-orchestrated audit of an entire codebase for materially useful simplifications in data structures, state representation, control flow, algorithms, and ownership. Use when the user wants a whole-codebase simplification review, a coverage-contracted audit of state modeling / invalid states, or a coordinator-plus-workers sweep that recommends but never edits. Adapted from Aaron Francis (https://gist.github.com/aarondfrancis/8735edbe48532f97ee5ea818db4dbd47).
---
